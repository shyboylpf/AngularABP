...
{
    public abstract class LiusStoreWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LiusStoreWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LiusStoreWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LiusStoreDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LiusStoreDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LiusStoreDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LiusStoreDbContext, Task<T>> func)
        {
            T result;
